...
export declare class Dispatcher {
    ...
    static register: <P extends ExpressCreator>(creator: P, config: ExpressOption<P>) => Promise<void>;
    static create: (redisOpt: redis.ClientOpts | RxRedis) => Dispatcher;
    private chose;
    push: <T>(source: T, handler_name: string) => Observable<ExpressInfo<any>>;
    query: (param: QueryParam, force?: boolean, handler_name?: string) => Observable<any>;
